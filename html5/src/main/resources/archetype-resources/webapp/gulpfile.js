...
gulp.task('copy:buildAppAssets', function () {
    ...
    gulp.src(['build/vendor/mdk-html5-lib-core/assets/**', 'build/vendor/mdk-html5-lib-core/assets/!**/*.scss', 'build/vendor/mdk-html5-lib-core/assets/!**/*.css'])
        .pipe(gulp.dest(userConfig.build_dir + '/assets'));
    gulp.src(['build/vendor/mdk-html5-lib-ui/assets/**', 'build/vendor/mdk-html5-lib-ui/assets/!**/*.scss', 'build/vendor/mdk-html5-lib-ui/assets/!**/*.css'])
        .pipe(gulp.dest(userConfig.build_dir + '/assets'));
 ...
 * build:fwk permits to launched the gulpfile of mdk-html5-lib-core and mdk-html5-lib-ui.
 */
gulp.task('build:fwk', function () {
    gulp.src(['build/vendor/mdk-html5-lib-core/gulpfile.js', 'build/vendor/mdk-html5-lib-ui/gulpfile.js'])
        .pipe(chug())
});
